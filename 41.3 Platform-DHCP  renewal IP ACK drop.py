"""
Description:
The AIM of the test case is to verify the behavior of DUT, when it failed to renewal the IP
...
try:
    for iteration in range(1, int(timesLoop) + 1):
        ...
        for x in range(6):
            api.waitSec(45)
            adbLogs.printGenericLogs(t.server, t.slotNo, tag="DhcpClient:D", search="DHCPREQUEST")
