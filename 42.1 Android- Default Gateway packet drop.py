"""
Description:
The AIM of the test case is to verify the behavior of the DUT, when Address resolution protocol doesn't work due to
 packets drop
...
try:
    ...
    api.writeDebugLine("Default Gateway packet dropped and recover passed")
    setStepStatus(api.TM.PASS)
