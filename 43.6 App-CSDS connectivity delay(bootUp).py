...
launcher failed to get the response from service discovery due to packet delay
...
try:
    for iteration in range(1, int(timesLoop) + 1):
        ...
        kmaxImpairment.switchImpairment_ON(impairment='CSDS', delay=6, filterNo=filterNo)
    ...
    api.writeDebugLine("Vodafone Launcher CSDS connectivity delayed and recover passed")
    setStepStatus(api.TM.PASS)
