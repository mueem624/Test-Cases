"""
Description:
The AIM of the test case is to verify the behavior of the DUT,while it's boot up from the powerless state and  and VF
launcher failed to get the response from session Guard due to packet delay
...
try:
    ...
    api.writeDebugLine("Session Guard connectivity packet delayed and recover passed")
    setStepStatus(api.TM.PASS)
